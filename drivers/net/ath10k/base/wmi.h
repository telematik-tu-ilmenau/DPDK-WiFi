...
static inline char *wmi_cmd_id_name(int cmd_id)
{
#define SVCSTR(x) case x: return #x

    switch (cmd_id) {
    SVCSTR(WMI_10_4_END_CMDID);
    SVCSTR(WMI_10_4_INIT_CMDID);
    SVCSTR(WMI_10_4_START_SCAN_CMDID);
    SVCSTR(WMI_10_4_STOP_SCAN_CMDID);
    SVCSTR(WMI_10_4_SCAN_CHAN_LIST_CMDID);
    SVCSTR(WMI_10_4_SCAN_SCH_PRIO_TBL_CMDID);
    SVCSTR(WMI_10_4_SCAN_UPDATE_REQUEST_CMDID);
    SVCSTR(WMI_10_4_ECHO_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_REGDOMAIN_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_CHANNEL_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_PARAM_CMDID);
    SVCSTR(WMI_10_4_PDEV_PKTLOG_ENABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_PKTLOG_DISABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_WMM_PARAMS_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_HT_CAP_IE_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_VHT_CAP_IE_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_BASE_MACADDR_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_DSCP_TID_MAP_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_QUIET_MODE_CMDID);
    SVCSTR(WMI_10_4_PDEV_GREEN_AP_PS_ENABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_GET_TPC_CONFIG_CMDID);
    SVCSTR(WMI_10_4_VDEV_CREATE_CMDID);
    SVCSTR(WMI_10_4_VDEV_DELETE_CMDID);
    SVCSTR(WMI_10_4_VDEV_START_REQUEST_CMDID);
    SVCSTR(WMI_10_4_VDEV_RESTART_REQUEST_CMDID);
    SVCSTR(WMI_10_4_VDEV_UP_CMDID);
    SVCSTR(WMI_10_4_VDEV_STOP_CMDID);
    SVCSTR(WMI_10_4_VDEV_DOWN_CMDID);
    SVCSTR(WMI_10_4_VDEV_STANDBY_RESPONSE_CMDID);
    SVCSTR(WMI_10_4_VDEV_RESUME_RESPONSE_CMDID);
    SVCSTR(WMI_10_4_VDEV_SET_PARAM_CMDID);
    SVCSTR(WMI_10_4_VDEV_INSTALL_KEY_CMDID);
    SVCSTR(WMI_10_4_WLAN_PEER_CACHING_ADD_PEER_CMDID);
    SVCSTR(WMI_10_4_WLAN_PEER_CACHING_EVICT_PEER_CMDID);
    SVCSTR(WMI_10_4_WLAN_PEER_CACHING_RESTORE_PEER_CMDID);
    SVCSTR(WMI_10_4_WLAN_PEER_CACHING_PRINT_ALL_PEERS_INFO_CMDID);
    SVCSTR(WMI_10_4_PEER_CREATE_CMDID);
    SVCSTR(WMI_10_4_PEER_DELETE_CMDID);
    SVCSTR(WMI_10_4_PEER_FLUSH_TIDS_CMDID);
    SVCSTR(WMI_10_4_PEER_SET_PARAM_CMDID);
    SVCSTR(WMI_10_4_PEER_ASSOC_CMDID);
    SVCSTR(WMI_10_4_PEER_ADD_WDS_ENTRY_CMDID);
    SVCSTR(WMI_10_4_PEER_UPDATE_WDS_ENTRY_CMDID);
    SVCSTR(WMI_10_4_PEER_REMOVE_WDS_ENTRY_CMDID);
    SVCSTR(WMI_10_4_PEER_ADD_PROXY_STA_ENTRY_CMDID);
    SVCSTR(WMI_10_4_PEER_MCAST_GROUP_CMDID);
    SVCSTR(WMI_10_4_BCN_TX_CMDID);
    SVCSTR(WMI_10_4_PDEV_SEND_BCN_CMDID);
    SVCSTR(WMI_10_4_BCN_PRB_TMPL_CMDID);
    SVCSTR(WMI_10_4_BCN_FILTER_RX_CMDID);
    SVCSTR(WMI_10_4_PRB_REQ_FILTER_RX_CMDID);
    SVCSTR(WMI_10_4_MGMT_TX_CMDID);
    SVCSTR(WMI_10_4_PRB_TMPL_CMDID);
    SVCSTR(WMI_10_4_ADDBA_CLEAR_RESP_CMDID);
    SVCSTR(WMI_10_4_ADDBA_SEND_CMDID);
    SVCSTR(WMI_10_4_ADDBA_STATUS_CMDID);
    SVCSTR(WMI_10_4_DELBA_SEND_CMDID);
    SVCSTR(WMI_10_4_ADDBA_SET_RESP_CMDID);
    SVCSTR(WMI_10_4_SEND_SINGLEAMSDU_CMDID);
    SVCSTR(WMI_10_4_STA_POWERSAVE_MODE_CMDID);
    SVCSTR(WMI_10_4_STA_POWERSAVE_PARAM_CMDID);
    SVCSTR(WMI_10_4_STA_MIMO_PS_MODE_CMDID);
    SVCSTR(WMI_10_4_DBGLOG_CFG_CMDID);
    SVCSTR(WMI_10_4_PDEV_DFS_ENABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_DFS_DISABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_QVIT_CMDID);
    SVCSTR(WMI_10_4_ROAM_SCAN_MODE);
    SVCSTR(WMI_10_4_ROAM_SCAN_RSSI_THRESHOLD);
    SVCSTR(WMI_10_4_ROAM_SCAN_PERIOD);
    SVCSTR(WMI_10_4_ROAM_SCAN_RSSI_CHANGE_THRESHOLD);
    SVCSTR(WMI_10_4_ROAM_AP_PROFILE);
    SVCSTR(WMI_10_4_OFL_SCAN_ADD_AP_PROFILE);
    SVCSTR(WMI_10_4_OFL_SCAN_REMOVE_AP_PROFILE);
    SVCSTR(WMI_10_4_OFL_SCAN_PERIOD);
    SVCSTR(WMI_10_4_P2P_DEV_SET_DEVICE_INFO);
    SVCSTR(WMI_10_4_P2P_DEV_SET_DISCOVERABILITY);
    SVCSTR(WMI_10_4_P2P_GO_SET_BEACON_IE);
    SVCSTR(WMI_10_4_P2P_GO_SET_PROBE_RESP_IE);
    SVCSTR(WMI_10_4_P2P_SET_VENDOR_IE_DATA_CMDID);
    SVCSTR(WMI_10_4_AP_PS_PEER_PARAM_CMDID);
    SVCSTR(WMI_10_4_AP_PS_PEER_UAPSD_COEX_CMDID);
    SVCSTR(WMI_10_4_PEER_RATE_RETRY_SCHED_CMDID);
    SVCSTR(WMI_10_4_WLAN_PROFILE_TRIGGER_CMDID);
    SVCSTR(WMI_10_4_WLAN_PROFILE_SET_HIST_INTVL_CMDID);
    SVCSTR(WMI_10_4_WLAN_PROFILE_GET_PROFILE_DATA_CMDID);
    SVCSTR(WMI_10_4_WLAN_PROFILE_ENABLE_PROFILE_ID_CMDID);
    SVCSTR(WMI_10_4_WLAN_PROFILE_LIST_PROFILE_ID_CMDID);
    SVCSTR(WMI_10_4_PDEV_SUSPEND_CMDID);
    SVCSTR(WMI_10_4_PDEV_RESUME_CMDID);
    SVCSTR(WMI_10_4_ADD_BCN_FILTER_CMDID);
    SVCSTR(WMI_10_4_RMV_BCN_FILTER_CMDID);
    SVCSTR(WMI_10_4_WOW_ADD_WAKE_PATTERN_CMDID);
    SVCSTR(WMI_10_4_WOW_DEL_WAKE_PATTERN_CMDID);
    SVCSTR(WMI_10_4_WOW_ENABLE_DISABLE_WAKE_EVENT_CMDID);
    SVCSTR(WMI_10_4_WOW_ENABLE_CMDID);
    SVCSTR(WMI_10_4_WOW_HOSTWAKEUP_FROM_SLEEP_CMDID);
    SVCSTR(WMI_10_4_RTT_MEASREQ_CMDID);
    SVCSTR(WMI_10_4_RTT_TSF_CMDID);
    SVCSTR(WMI_10_4_RTT_KEEPALIVE_CMDID);
    SVCSTR(WMI_10_4_OEM_REQ_CMDID);
    SVCSTR(WMI_10_4_NAN_CMDID);
    SVCSTR(WMI_10_4_VDEV_SPECTRAL_SCAN_CONFIGURE_CMDID);
    SVCSTR(WMI_10_4_VDEV_SPECTRAL_SCAN_ENABLE_CMDID);
    SVCSTR(WMI_10_4_REQUEST_STATS_CMDID);
    SVCSTR(WMI_10_4_GPIO_CONFIG_CMDID);
    SVCSTR(WMI_10_4_GPIO_OUTPUT_CMDID);
    SVCSTR(WMI_10_4_VDEV_RATEMASK_CMDID);
    SVCSTR(WMI_10_4_CSA_OFFLOAD_ENABLE_CMDID);
    SVCSTR(WMI_10_4_GTK_OFFLOAD_CMDID);
    SVCSTR(WMI_10_4_QBOOST_CFG_CMDID);
    SVCSTR(WMI_10_4_CSA_OFFLOAD_CHANSWITCH_CMDID);
    SVCSTR(WMI_10_4_PDEV_SMART_ANT_ENABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_SMART_ANT_SET_RX_ANTENNA_CMDID);
    SVCSTR(WMI_10_4_PEER_SMART_ANT_SET_TX_ANTENNA_CMDID);
    SVCSTR(WMI_10_4_PEER_SMART_ANT_SET_TRAIN_INFO_CMDID);
    SVCSTR(WMI_10_4_PEER_SMART_ANT_SET_NODE_CONFIG_OPS_CMDID);
    SVCSTR(WMI_10_4_VDEV_SET_KEEPALIVE_CMDID);
    SVCSTR(WMI_10_4_VDEV_GET_KEEPALIVE_CMDID);
    SVCSTR(WMI_10_4_FORCE_FW_HANG_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_ANTENNA_SWITCH_TABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_CTL_TABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_SET_MIMOGAIN_TABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_RATEPWR_TABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_RATEPWR_CHAINMSK_TABLE_CMDID);
    SVCSTR(WMI_10_4_PDEV_FIPS_CMDID);
    SVCSTR(WMI_10_4_TT_SET_CONF_CMDID);
    SVCSTR(WMI_10_4_FWTEST_CMDID);
    SVCSTR(WMI_10_4_VDEV_ATF_REQUEST_CMDID);
    SVCSTR(WMI_10_4_PEER_ATF_REQUEST_CMDID);
    SVCSTR(WMI_10_4_PDEV_GET_ANI_CCK_CONFIG_CMDID);
    SVCSTR(WMI_10_4_PDEV_GET_ANI_OFDM_CONFIG_CMDID);
    SVCSTR(WMI_10_4_PDEV_RESERVE_AST_ENTRY_CMDID);
    SVCSTR(WMI_10_4_PDEV_GET_NFCAL_POWER_CMDID);
    SVCSTR(WMI_10_4_PDEV_GET_TPC_CMDID);
    SVCSTR(WMI_10_4_PDEV_GET_AST_INFO_CMDID);
    SVCSTR(WMI_10_4_VDEV_SET_DSCP_TID_MAP_CMDID);
    SVCSTR(WMI_10_4_PDEV_GET_TEMPERATURE_CMDID);
    SVCSTR(WMI_10_4_PDEV_GET_INFO_CMDID);
    SVCSTR(WMI_10_4_VDEV_GET_INFO_CMDID);
    SVCSTR(WMI_10_4_VDEV_FILTER_NEIGHBOR_RX_PACKETS_CMDID);
    SVCSTR(WMI_10_4_MU_CAL_START_CMDID);
    SVCSTR(WMI_10_4_SET_CCA_PARAMS_CMDID);
    SVCSTR(WMI_10_4_PDEV_BSS_CHAN_INFO_REQUEST_CMDID);
    SVCSTR(WMI_10_4_EXT_RESOURCE_CFG_CMDID);
    SVCSTR(WMI_10_4_VDEV_SET_IE_CMDID);
    SVCSTR(WMI_10_4_SET_LTEU_CONFIG_CMDID);
    SVCSTR(WMI_10_4_ATF_SSID_GROUPING_REQUEST_CMDID);
    SVCSTR(WMI_10_4_PEER_ATF_EXT_REQUEST_CMDID);
    SVCSTR(WMI_10_4_SET_PERIODIC_CHANNEL_STATS_CONFIG);
    SVCSTR(WMI_10_4_PEER_BWF_REQUEST_CMDID);
    SVCSTR(WMI_10_4_BTCOEX_CFG_CMDID);
    SVCSTR(WMI_10_4_PEER_TX_MU_TXMIT_COUNT_CMDID);
    SVCSTR(WMI_10_4_PEER_TX_MU_TXMIT_RSTCNT_CMDID);
    SVCSTR(WMI_10_4_PEER_GID_USERPOS_LIST_CMDID);
    SVCSTR(WMI_10_4_PDEV_CHECK_CAL_VERSION_CMDID);
    SVCSTR(WMI_10_4_COEX_VERSION_CFG_CMID);
    SVCSTR(WMI_10_4_PDEV_GET_RX_FILTER_CMDID);
    SVCSTR(WMI_10_4_PDEV_EXTENDED_NSS_CFG_CMDID);
    SVCSTR(WMI_10_4_VDEV_SET_SCAN_NAC_RSSI_CMDID);
    SVCSTR(WMI_10_4_PROG_GPIO_BAND_SELECT_CMDID);
    SVCSTR(WMI_10_4_CONFIG_SMART_LOGGING_CMDID);
    SVCSTR(WMI_10_4_DEBUG_FATAL_CONDITION_CMDID);
    SVCSTR(WMI_10_4_GET_TSF_TIMER_CMDID);
    SVCSTR(WMI_10_4_PDEV_GET_TPC_TABLE_CMDID);
    SVCSTR(WMI_10_4_VDEV_SIFS_TRIGGER_TIME_CMDID);
    SVCSTR(WMI_10_4_PDEV_WDS_ENTRY_LIST_CMDID);
    SVCSTR(WMI_10_4_TDLS_SET_STATE_CMDID);
    SVCSTR(WMI_10_4_TDLS_PEER_UPDATE_CMDID);
    SVCSTR(WMI_10_4_TDLS_SET_OFFCHAN_MODE_CMDID);
    SVCSTR(WMI_10_4_PDEV_UTF_CMDID);
    default:
        return NULL;
    }
...
static inline char *wmi_pdev_param_name(int pdev_param_id)
{
#define SVCSTR(x) case x: return #x

    switch (pdev_param_id) {
    SVCSTR(WMI_10_4_PDEV_PARAM_TX_CHAIN_MASK);
    SVCSTR(WMI_10_4_PDEV_PARAM_RX_CHAIN_MASK);
    SVCSTR(WMI_10_4_PDEV_PARAM_TXPOWER_LIMIT2G);
    SVCSTR(WMI_10_4_PDEV_PARAM_TXPOWER_LIMIT5G);
    SVCSTR(WMI_10_4_PDEV_PARAM_TXPOWER_SCALE);
    SVCSTR(WMI_10_4_PDEV_PARAM_BEACON_GEN_MODE);
    SVCSTR(WMI_10_4_PDEV_PARAM_BEACON_TX_MODE);
    SVCSTR(WMI_10_4_PDEV_PARAM_RESMGR_OFFCHAN_MODE);
    SVCSTR(WMI_10_4_PDEV_PARAM_PROTECTION_MODE);
    SVCSTR(WMI_10_4_PDEV_PARAM_DYNAMIC_BW);
    SVCSTR(WMI_10_4_PDEV_PARAM_NON_AGG_SW_RETRY_TH);
    SVCSTR(WMI_10_4_PDEV_PARAM_AGG_SW_RETRY_TH);
    SVCSTR(WMI_10_4_PDEV_PARAM_STA_KICKOUT_TH);
    SVCSTR(WMI_10_4_PDEV_PARAM_AC_AGGRSIZE_SCALING);
    SVCSTR(WMI_10_4_PDEV_PARAM_LTR_ENABLE);
    SVCSTR(WMI_10_4_PDEV_PARAM_LTR_AC_LATENCY_BE);
    SVCSTR(WMI_10_4_PDEV_PARAM_LTR_AC_LATENCY_BK);
    SVCSTR(WMI_10_4_PDEV_PARAM_LTR_AC_LATENCY_VI);
    SVCSTR(WMI_10_4_PDEV_PARAM_LTR_AC_LATENCY_VO);
    SVCSTR(WMI_10_4_PDEV_PARAM_LTR_AC_LATENCY_TIMEOUT);
    SVCSTR(WMI_10_4_PDEV_PARAM_LTR_SLEEP_OVERRIDE);
    SVCSTR(WMI_10_4_PDEV_PARAM_LTR_RX_OVERRIDE);
    SVCSTR(WMI_10_4_PDEV_PARAM_LTR_TX_ACTIVITY_TIMEOUT);
    SVCSTR(WMI_10_4_PDEV_PARAM_L1SS_ENABLE);
    SVCSTR(WMI_10_4_PDEV_PARAM_DSLEEP_ENABLE);
    SVCSTR(WMI_10_4_PDEV_PARAM_PCIELP_TXBUF_FLUSH);
    SVCSTR(WMI_10_4_PDEV_PARAM_PCIELP_TXBUF_WATERMARK);
    SVCSTR(WMI_10_4_PDEV_PARAM_PCIELP_TXBUF_TMO_EN);
    SVCSTR(WMI_10_4_PDEV_PARAM_PCIELP_TXBUF_TMO_VALUE);
    SVCSTR(WMI_10_4_PDEV_PARAM_PDEV_STATS_UPDATE_PERIOD);
    SVCSTR(WMI_10_4_PDEV_PARAM_VDEV_STATS_UPDATE_PERIOD);
    SVCSTR(WMI_10_4_PDEV_PARAM_PEER_STATS_UPDATE_PERIOD);
    SVCSTR(WMI_10_4_PDEV_PARAM_BCNFLT_STATS_UPDATE_PERIOD);
    SVCSTR(WMI_10_4_PDEV_PARAM_PMF_QOS);
    SVCSTR(WMI_10_4_PDEV_PARAM_ARP_AC_OVERRIDE);
    SVCSTR(WMI_10_4_PDEV_PARAM_DCS);
    SVCSTR(WMI_10_4_PDEV_PARAM_ANI_ENABLE);
    SVCSTR(WMI_10_4_PDEV_PARAM_ANI_POLL_PERIOD);
    SVCSTR(WMI_10_4_PDEV_PARAM_ANI_LISTEN_PERIOD);
    SVCSTR(WMI_10_4_PDEV_PARAM_ANI_OFDM_LEVEL);
    SVCSTR(WMI_10_4_PDEV_PARAM_ANI_CCK_LEVEL);
    SVCSTR(WMI_10_4_PDEV_PARAM_DYNTXCHAIN);
    SVCSTR(WMI_10_4_PDEV_PARAM_PROXY_STA);
    SVCSTR(WMI_10_4_PDEV_PARAM_IDLE_PS_CONFIG);
    SVCSTR(WMI_10_4_PDEV_PARAM_POWER_GATING_SLEEP);
    SVCSTR(WMI_10_4_PDEV_PARAM_AGGR_BURST);
    SVCSTR(WMI_10_4_PDEV_PARAM_RX_DECAP_MODE);
    SVCSTR(WMI_10_4_PDEV_PARAM_FAST_CHANNEL_RESET);
    SVCSTR(WMI_10_4_PDEV_PARAM_BURST_DUR);
    SVCSTR(WMI_10_4_PDEV_PARAM_BURST_ENABLE);
    SVCSTR(WMI_10_4_PDEV_PARAM_SMART_ANTENNA_DEFAULT_ANTENNA);
    SVCSTR(WMI_10_4_PDEV_PARAM_IGMPMLD_OVERRIDE);
    SVCSTR(WMI_10_4_PDEV_PARAM_IGMPMLD_TID);
    SVCSTR(WMI_10_4_PDEV_PARAM_ANTENNA_GAIN);
    SVCSTR(WMI_10_4_PDEV_PARAM_RX_FILTER);
    SVCSTR(WMI_10_4_PDEV_SET_MCAST_TO_UCAST_TID);
    SVCSTR(WMI_10_4_PDEV_PARAM_PROXY_STA_MODE);
    SVCSTR(WMI_10_4_PDEV_PARAM_SET_MCAST2UCAST_MODE);
    SVCSTR(WMI_10_4_PDEV_PARAM_SET_MCAST2UCAST_BUFFER);
    SVCSTR(WMI_10_4_PDEV_PARAM_REMOVE_MCAST2UCAST_BUFFER);
    SVCSTR(WMI_10_4_PDEV_PEER_STA_PS_STATECHG_ENABLE);
    SVCSTR(WMI_10_4_PDEV_PARAM_IGMPMLD_AC_OVERRIDE);
    SVCSTR(WMI_10_4_PDEV_PARAM_BLOCK_INTERBSS);
    SVCSTR(WMI_10_4_PDEV_PARAM_SET_DISABLE_RESET_CMDID);
    SVCSTR(WMI_10_4_PDEV_PARAM_SET_MSDU_TTL_CMDID);
    SVCSTR(WMI_10_4_PDEV_PARAM_SET_PPDU_DURATION_CMDID);
    SVCSTR(WMI_10_4_PDEV_PARAM_TXBF_SOUND_PERIOD_CMDID);
    SVCSTR(WMI_10_4_PDEV_PARAM_SET_PROMISC_MODE_CMDID);
    SVCSTR(WMI_10_4_PDEV_PARAM_SET_BURST_MODE_CMDID);
    SVCSTR(WMI_10_4_PDEV_PARAM_EN_STATS);
    SVCSTR(WMI_10_4_PDEV_PARAM_MU_GROUP_POLICY);
    SVCSTR(WMI_10_4_PDEV_PARAM_NOISE_DETECTION);
    SVCSTR(WMI_10_4_PDEV_PARAM_NOISE_THRESHOLD);
    SVCSTR(WMI_10_4_PDEV_PARAM_DPD_ENABLE);
    SVCSTR(WMI_10_4_PDEV_PARAM_SET_MCAST_BCAST_ECHO);
    SVCSTR(WMI_10_4_PDEV_PARAM_ATF_STRICT_SCH);
    SVCSTR(WMI_10_4_PDEV_PARAM_ATF_SCHED_DURATION);
    SVCSTR(WMI_10_4_PDEV_PARAM_ANT_PLZN);
    SVCSTR(WMI_10_4_PDEV_PARAM_MGMT_RETRY_LIMIT);
    SVCSTR(WMI_10_4_PDEV_PARAM_SENSITIVITY_LEVEL);
    SVCSTR(WMI_10_4_PDEV_PARAM_SIGNED_TXPOWER_2G);
    SVCSTR(WMI_10_4_PDEV_PARAM_SIGNED_TXPOWER_5G);
    SVCSTR(WMI_10_4_PDEV_PARAM_ENABLE_PER_TID_AMSDU);
    SVCSTR(WMI_10_4_PDEV_PARAM_ENABLE_PER_TID_AMPDU);
    SVCSTR(WMI_10_4_PDEV_PARAM_CCA_THRESHOLD);
    SVCSTR(WMI_10_4_PDEV_PARAM_RTS_FIXED_RATE);
    SVCSTR(WMI_10_4_PDEV_PARAM_CAL_PERIOD);
    SVCSTR(WMI_10_4_PDEV_PARAM_PDEV_RESET);
    SVCSTR(WMI_10_4_PDEV_PARAM_WAPI_MBSSID_OFFSET);
    SVCSTR(WMI_10_4_PDEV_PARAM_ARP_SRCADDR);
    SVCSTR(WMI_10_4_PDEV_PARAM_ARP_DSTADDR);
    SVCSTR(WMI_10_4_PDEV_PARAM_TXPOWER_DECR_DB);
    SVCSTR(WMI_10_4_PDEV_PARAM_RX_BATCHMODE);
    SVCSTR(WMI_10_4_PDEV_PARAM_PACKET_AGGR_DELAY);
    SVCSTR(WMI_10_4_PDEV_PARAM_ATF_OBSS_NOISE_SCH);
    SVCSTR(WMI_10_4_PDEV_PARAM_ATF_OBSS_NOISE_SCALING_FACTOR);
    SVCSTR(WMI_10_4_PDEV_PARAM_CUST_TXPOWER_SCALE);
    SVCSTR(WMI_10_4_PDEV_PARAM_ATF_DYNAMIC_ENABLE);
    SVCSTR(WMI_10_4_PDEV_PARAM_ATF_SSID_GROUP_POLICY);
    SVCSTR(WMI_10_4_PDEV_PARAM_ENABLE_BTCOEX);
    default:
        return NULL;
    }
...
static inline char *wmi_vdev_param_name(int vdev_param_id)
{
#define SVCSTR(x) case x: return #x

    switch (vdev_param_id) {
    SVCSTR(WMI_10_4_VDEV_PARAM_RTS_THRESHOLD);
    SVCSTR(WMI_10_4_VDEV_PARAM_FRAGMENTATION_THRESHOLD);
    SVCSTR(WMI_10_4_VDEV_PARAM_BEACON_INTERVAL);
    SVCSTR(WMI_10_4_VDEV_PARAM_LISTEN_INTERVAL);
    SVCSTR(WMI_10_4_VDEV_PARAM_MULTICAST_RATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_MGMT_TX_RATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_SLOT_TIME);
    SVCSTR(WMI_10_4_VDEV_PARAM_PREAMBLE);
    SVCSTR(WMI_10_4_VDEV_PARAM_SWBA_TIME);
    SVCSTR(WMI_10_4_VDEV_STATS_UPDATE_PERIOD);
    SVCSTR(WMI_10_4_VDEV_PWRSAVE_AGEOUT_TIME);
    SVCSTR(WMI_10_4_VDEV_HOST_SWBA_INTERVAL);
    SVCSTR(WMI_10_4_VDEV_PARAM_DTIM_PERIOD);
    SVCSTR(WMI_10_4_VDEV_OC_SCHEDULER_AIR_TIME_LIMIT);
    SVCSTR(WMI_10_4_VDEV_PARAM_WDS);
    SVCSTR(WMI_10_4_VDEV_PARAM_ATIM_WINDOW);
    SVCSTR(WMI_10_4_VDEV_PARAM_BMISS_COUNT_MAX);
    SVCSTR(WMI_10_4_VDEV_PARAM_BMISS_FIRST_BCNT);
    SVCSTR(WMI_10_4_VDEV_PARAM_BMISS_FINAL_BCNT);
    SVCSTR(WMI_10_4_VDEV_PARAM_FEATURE_WMM);
    SVCSTR(WMI_10_4_VDEV_PARAM_CHWIDTH);
    SVCSTR(WMI_10_4_VDEV_PARAM_CHEXTOFFSET);
    SVCSTR(WMI_10_4_VDEV_PARAM_DISABLE_HTPROTECTION);
    SVCSTR(WMI_10_4_VDEV_PARAM_STA_QUICKKICKOUT);
    SVCSTR(WMI_10_4_VDEV_PARAM_MGMT_RATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_PROTECTION_MODE);
    SVCSTR(WMI_10_4_VDEV_PARAM_FIXED_RATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_SGI);
    SVCSTR(WMI_10_4_VDEV_PARAM_LDPC);
    SVCSTR(WMI_10_4_VDEV_PARAM_TX_STBC);
    SVCSTR(WMI_10_4_VDEV_PARAM_RX_STBC);
    SVCSTR(WMI_10_4_VDEV_PARAM_INTRA_BSS_FWD);
    SVCSTR(WMI_10_4_VDEV_PARAM_DEF_KEYID);
    SVCSTR(WMI_10_4_VDEV_PARAM_NSS);
    SVCSTR(WMI_10_4_VDEV_PARAM_BCAST_DATA_RATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_MCAST_DATA_RATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_MCAST_INDICATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_DHCP_INDICATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_UNKNOWN_DEST_INDICATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_AP_KEEPALIVE_MIN_IDLE_INACTIVE_TIME_SECS);
    SVCSTR(WMI_10_4_VDEV_PARAM_AP_KEEPALIVE_MAX_IDLE_INACTIVE_TIME_SECS);
    SVCSTR(WMI_10_4_VDEV_PARAM_AP_KEEPALIVE_MAX_UNRESPONSIVE_TIME_SECS);
    SVCSTR(WMI_10_4_VDEV_PARAM_AP_ENABLE_NAWDS);
    SVCSTR(WMI_10_4_VDEV_PARAM_MCAST2UCAST_SET);
    SVCSTR(WMI_10_4_VDEV_PARAM_ENABLE_RTSCTS);
    SVCSTR(WMI_10_4_VDEV_PARAM_RC_NUM_RETRIES);
    SVCSTR(WMI_10_4_VDEV_PARAM_TXBF);
    SVCSTR(WMI_10_4_VDEV_PARAM_PACKET_POWERSAVE);
    SVCSTR(WMI_10_4_VDEV_PARAM_DROP_UNENCRY);
    SVCSTR(WMI_10_4_VDEV_PARAM_TX_ENCAP_TYPE);
    SVCSTR(WMI_10_4_VDEV_PARAM_AP_DETECT_OUT_OF_SYNC_SLEEPING_STA_TIME_SECS);
    SVCSTR(WMI_10_4_VDEV_PARAM_CABQ_MAXDUR);
    SVCSTR(WMI_10_4_VDEV_PARAM_MFPTEST_SET);
    SVCSTR(WMI_10_4_VDEV_PARAM_RTS_FIXED_RATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_VHT_SGIMASK);
    SVCSTR(WMI_10_4_VDEV_PARAM_VHT80_RATEMASK);
    SVCSTR(WMI_10_4_VDEV_PARAM_EARLY_RX_ADJUST_ENABLE);
    SVCSTR(WMI_10_4_VDEV_PARAM_EARLY_RX_TGT_BMISS_NUM);
    SVCSTR(WMI_10_4_VDEV_PARAM_EARLY_RX_BMISS_SAMPLE_CYCLE);
    SVCSTR(WMI_10_4_VDEV_PARAM_EARLY_RX_SLOP_STEP);
    SVCSTR(WMI_10_4_VDEV_PARAM_EARLY_RX_INIT_SLOP);
    SVCSTR(WMI_10_4_VDEV_PARAM_EARLY_RX_ADJUST_PAUSE);
    SVCSTR(WMI_10_4_VDEV_PARAM_PROXY_STA);
    SVCSTR(WMI_10_4_VDEV_PARAM_MERU_VC);
    SVCSTR(WMI_10_4_VDEV_PARAM_RX_DECAP_TYPE);
    SVCSTR(WMI_10_4_VDEV_PARAM_BW_NSS_RATEMASK);
    SVCSTR(WMI_10_4_VDEV_PARAM_SENSOR_AP);
    SVCSTR(WMI_10_4_VDEV_PARAM_BEACON_RATE);
    SVCSTR(WMI_10_4_VDEV_PARAM_DTIM_ENABLE_CTS);
    SVCSTR(WMI_10_4_VDEV_PARAM_STA_KICKOUT);
    SVCSTR(WMI_10_4_VDEV_PARAM_CAPABILITIES);
    SVCSTR(WMI_10_4_VDEV_PARAM_TSF_INCREMENT);
    SVCSTR(WMI_10_4_VDEV_PARAM_RX_FILTER);
    SVCSTR(WMI_10_4_VDEV_PARAM_MGMT_TX_POWER);
    SVCSTR(WMI_10_4_VDEV_PARAM_ATF_SSID_SCHED_POLICY);
    SVCSTR(WMI_10_4_VDEV_PARAM_DISABLE_DYN_BW_RTS);
    SVCSTR(WMI_10_4_VDEV_PARAM_TSF_DECREMENT);
    default:
        return NULL;
    }
...
static inline char *wmi_peer_param_name(int peer_param_id)
{
#define SVCSTR(x) case x: return #x

    switch (peer_param_id) {
    SVCSTR(WMI_PEER_SMPS_STATE);
    SVCSTR(WMI_PEER_AMPDU);
    SVCSTR(WMI_PEER_AUTHORIZE);
    SVCSTR(WMI_PEER_CHAN_WIDTH);
    SVCSTR(WMI_PEER_NSS);
    SVCSTR(WMI_PEER_USE_4ADDR);
    SVCSTR(WMI_PEER_DEBUG);
    SVCSTR(WMI_PEER_DUMMY_VAR);
    default:
        return NULL;
    }
