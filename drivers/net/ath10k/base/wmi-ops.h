...
ath10k_wmi_pdev_set_param(struct ath10k *ar, u32 id, u32 value)
{
	...
	RTE_LOG(ERR, PMD, "ath10k_wmi_pdev_set_param: %d (%s) - %d (0x%x)\n", id, wmi_pdev_param_name(id), value);
			  ...
			  u32 param_value)
{
	...
	RTE_LOG(ERR, PMD, "ath10k_wmi_vdev_set_param: %d (%s) - %d (0x%x)\n", param_id, wmi_vdev_param_name(param_id), param_value);
			  ...
			  enum wmi_peer_param param_id, u32 param_value)
{
	...
	RTE_LOG(ERR, PMD, "ath10k_wmi_peer_set_param: %d (%s) - %d (0x%x)\n", param_id, wmi_peer_param_name(param_id), param_value);
