...
struct ath10k_hw_regs {
	...
	uint32_t ce8_base_address;
	uint32_t ce9_base_address;
	uint32_t ce10_base_address;
	uint32_t ce11_base_address;
...
#define TARGET_10X_NUM_TIDS			min_t(int,(TARGET_10X_NUM_TIDS_MAX), \
						    (TARGET_10X_NUM_PEERS) * 2)
#define TARGET_10X_TX_STATS_NUM_TIDS		min_t(int, (TARGET_10X_NUM_TIDS_MAX), \
