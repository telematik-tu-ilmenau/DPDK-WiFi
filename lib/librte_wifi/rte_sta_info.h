...
#ifndef RTE_STA_INFO_H
#define RTE_STA_INFO_H
...
//    uint8_t stop_initiator;
//    bool tx_stop;
//    uint8_t buf_size;
//
//    uint16_t failed_bar_ssn;
//    bool bar_pending;
//    bool amsdu;
//};
//
...
//    uint16_t head_seq_num;
//    uint16_t stored_mpdu_num;
//    uint16_t ssn;
//    uint16_t buf_size;
//    uint16_t timeout;
//    uint8_t auto_seq:1,
...
//    uint8_t tid_rx_token[IEEE80211_NUM_TIDS];
...
//    uint8_t addba_req_num[IEEE80211_NUM_TIDS];
...
//    uint8_t hdr_len;
//    uint8_t sa_offs, da_offs, pn_offs;
//    uint8_t band;
//    uint8_t hdr[30 + 2 + IEEE80211_FAST_XMIT_MAX_IV +
...
//    uint8_t vif_addr[ETH_ALEN] __aligned(2);
//    uint8_t rfc1042_hdr[6] __aligned(2);
...
//    struct list_head /*list, */free_list;
    LIST_ENTRY(sta_info) pointers;
    LIST_ENTRY(sta_info) pointers_free_list;
//    struct rcu_head rcu_head;
...
//    } status_stats;
    ...
    struct {
        uint64_t packets[IEEE80211_NUM_ACS];
        uint64_t bytes[IEEE80211_NUM_ACS];
        struct ieee80211_tx_rate last_rate;
        uint64_t msdu[IEEE80211_NUM_TIDS + 1];
    } tx_stats;
    uint16_t tid_seq[IEEE80211_QOS_CTL_TID_MASK + 1];

//    /*
//     * Aggregation information, locked with lock.
//     */
//    struct sta_ampdu_mlme ampdu_mlme;
//    uint8_t timer_to_tid[IEEE80211_NUM_TIDS];
//
...
//
//static inline uint32_t sta_stats_encode_rate(struct ieee80211_rx_status *s)
//{
//    uint16_t r;
//
